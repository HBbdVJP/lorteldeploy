...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const animationRefs = new Map(); // Lưu các requestId để hủy khi unmount
          ...
          if (entry.isIntersecting) {
            ...
            const updateCounter = (currentTime) => {
              ...
              if (progress < 1) {
                ...
                animationRefs.set(counter, frameId);
              } else {
                counter.innerText = target;
                observer.unobserve(counter);
                animationRefs.delete(counter);
              }
            };
    ...
    // Cleanup: hủy tất cả animation frame khi component unmount
    return () => {
      observer.disconnect();
      animationRefs.forEach((frameId) => cancelAnimationFrame(frameId));
      animationRefs.clear();
    };
  }, []);
  const handleContactSubmit = (e) => {
    e.preventDefault();
    showToast(
      `Cảm ơn ${contactData.name}! Chúng tôi sẽ phản hồi trong thời gian sớm nhất.`,
      "success",
    );
      ...
      try {
        ...
        const roomList = (data.Room ?? []).map((room) => {
          ...
          return {
            ...
            description:
              roomType?.Description || "Phòng tiện nghi với đầy đủ tiện ích.",
        ...
        const couponList = (data.Coupon ?? []).map((coupon) => ({
          ...coupon,
          promoName:
            promos.find((promo) => promo.PromoID === coupon.PromoID)
              ?.PromoName || "Ưu đãi đặc biệt",
        }));
  ...
  return (
    <>
        ...
        <section className="relative h-screen min-h-150 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white pointer-events-none">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-slide-up">
              Chào mừng đến LORTEL
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-2xl animate-slide-up opacity-90">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                Nơi thiên nhiên gặp gỡ sự sang trọng
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-800 mb-4">
                  Thiên đường nghỉ dưỡng giữa lòng thiên nhiên
                </h3>
                <p className="text-gray-600 mb-4 leading-relaxed">
                  Tọa lạc tại vị trí đắc địa với view biển và rừng núi hùng vĩ,
                  LORTEL Resort mang đến không gian nghỉ dưỡng lý tưởng cho
                  những ai tìm kiếm sự bình yên và sang trọng.
                </p>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Với kiến trúc độc đáo kết hợp hài hòa giữa phong cách hiện đại
                  và văn hóa bản địa, mỗi góc tại LORTEL đều là một tác phẩm
                  nghệ thuật.
                </p>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center gap-2">
                    <i className="fas fa-check-circle text-emerald-600"></i>
                    <span>150+ phòng nghỉ cao cấp</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <i className="fas fa-check-circle text-emerald-600"></i>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 mt-4">
                Trải nghiệm không gian nghỉ dưỡng đẳng cấp với các loại phòng đa
                dạng
              </p>
            </div>
                ...
                rooms.slice(0, 3).map((room, index) => (
                  ...
                  >
                    <div className="relative h-56 overflow-hidden">
                      <img
                        src={`https://picsum.photos/id/${170 + index}/400/300`}
                        alt={room.type}
                        className="w-full h-full object-cover hover:scale-110 transition duration-500"
                      />
                      <span
                        className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm ${room.status === "Available" ? "bg-emerald-600 text-white" : "bg-gray-400 text-white"}`}
                      >
            ...
            <div className="text-center mt-10">
              <Link
                href="/booking"
                className="inline-flex items-center gap-2 border-2 border-emerald-600 text-emerald-600 px-8 py-3 rounded-full font-semibold hover:bg-emerald-600 hover:text-white transition"
              >
        ...
        <section id="promotions" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <div className="w-20 h-1 bg-emerald-600 mx-auto"></div>
              <p className="text-gray-600 mt-4">
                Ưu đãi đặc biệt dành cho khách hàng của LORTEL
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Card 1 - Giảm 30% */}
              <div className="bg-white border-2 border-emerald-600 rounded-2xl p-6 text-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
                <i className="fas fa-gift text-4xl mb-4 text-emerald-600"></i>
                <h3 className="text-2xl font-bold mb-2">Giảm 30%</h3>
                <p className="mb-2">Cho tất cả phòng Deluxe</p>
                <p className="text-sm text-gray-500">Áp dụng đến 30/04/2024</p>
                <div className="mt-4 bg-emerald-50 border border-emerald-200 rounded-lg px-4 py-2 inline-block">
              ...
              {/* Card 2 - Đặt 3 tặng 1 */}
              <div className="bg-white border-2 border-emerald-600 rounded-2xl p-6 text-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
                <i className="fas fa-calendar-week text-4xl mb-4 text-emerald-600"></i>
                <h3 className="text-2xl font-bold mb-2">Đặt 3 tặng 1</h3>
                <p className="mb-2">Đặt 3 đêm tặng 1 đêm miễn phí</p>
                <p className="text-sm text-gray-500">Dịp lễ 30/4 - 1/5</p>
                <div className="mt-4 bg-emerald-50 border border-emerald-200 rounded-lg px-4 py-2 inline-block">
                  <span className="font-mono text-emerald-700 font-semibold">
                    STAY4FREE
                  </span>
              ...
              {/* Card 3 - Ưu đãi nhóm */}
              <div className="bg-white border-2 border-emerald-600 rounded-2xl p-6 text-gray-800 shadow-sm hover:shadow-md transition-all duration-300">
                <i className="fas fa-users text-4xl mb-4 text-emerald-600"></i>
                <h3 className="text-2xl font-bold mb-2">Ưu đãi nhóm</h3>
                <p className="mb-2">Đặt từ 3 phòng trở lên giảm 15%</p>
                <p className="text-sm text-gray-500">Áp dụng quanh năm</p>
                <div className="mt-4 bg-emerald-50 border border-emerald-200 rounded-lg px-4 py-2 inline-block">
                  <span className="font-mono text-emerald-700 font-semibold">
                    GROUP15
                  </span>
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Đăng nhập để nhận thêm nhiều ưu đãi độc quyền
                  </p>
                </div>
                <Link
                  href="/login"
        ...
        <section className="py-20 bg-gray-100">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <div className="w-20 h-1 bg-emerald-600 mx-auto"></div>
              <p className="text-gray-600 mt-4">
                Trải nghiệm đẳng cấp với các dịch vụ cao cấp
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="service-card text-center p-6 border rounded-2xl hover:border-emerald-600 bg-white">
                ...
                <p className="text-gray-500 text-sm">
                  Ẩm thực đa dạng với các món Á - Âu tinh tế
                </p>
              </div>
              <div className="service-card text-center p-6 border rounded-2xl hover:border-emerald-600 bg-white">
                <div className="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-500 text-sm">
                  Liệu pháp thư giãn đẳng cấp, chăm sóc sức khỏe
                </p>
              </div>
              <div className="service-card text-center p-6 border rounded-2xl hover:border-emerald-600 bg-white">
                <div className="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-500 text-sm">
                  Hồ bơi vô cực với view biển tuyệt đẹp
                </p>
              </div>
              <div className="service-card text-center p-6 border rounded-2xl hover:border-emerald-600 bg-white">
                <div className="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-500 text-sm">
                  Phòng gym hiện đại với thiết bị cao cấp
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="testimonial-card bg-gray-50 p-6 rounded-2xl shadow-md">
                ...
                <p className="text-gray-600 italic mb-4">
                  "Trải nghiệm tuyệt vời! Phòng đẹp, view biển cực kỳ ấn tượng.
                  Nhân viên thân thiện, nhiệt tình. Nhất định sẽ quay lại!"
                </p>
              ...
              <div className="testimonial-card bg-gray-50 p-6 rounded-2xl shadow-md">
                ...
                <p className="text-gray-600 italic mb-4">
                  "Không gian resort rất đẹp, yên tĩnh. Ẩm thực phong phú, đặc
                  biệt là buffet sáng. Spa thư giãn tuyệt vời!"
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
                    <i className="fas fa-user text-emerald-600 text-xl"></i>
              ...
              <div className="testimonial-card bg-gray-50 p-6 rounded-2xl shadow-md">
                ...
                <p className="text-gray-600 italic mb-4">
                  "Dịch vụ chuyên nghiệp, phòng sạch sẽ, view rừng thông rất thơ
                  mộng. Sẽ giới thiệu bạn bè đến đây."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
                    <i className="fas fa-user text-emerald-600 text-xl"></i>
                  ...
                  <form onSubmit={handleContactSubmit}>
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="contact-input w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none"
                      />
                    </div>
                    <div className="mb-4">
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          123 Lê Thánh Tôn, Quận 1, TP. Hồ Chí Minh
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                  ...
                  <div className="mt-8 pt-6 border-t">
                    ...
                    <div className="flex gap-3">
                      <a
                        href="#"
                        className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-emerald-600 hover:text-white transition"
                      >
        ...
        <section className="py-16 bg-emerald-600">
          <div className="container mx-auto px-4 text-center text-white">
            ...
            <p className="mb-6 opacity-90">
              Đăng ký nhận bản tin để nhận thông tin khuyến mãi mới nhất
            </p>
      ...
      {toast.visible && (
        <div
          className={`fixed bottom-5 right-5 px-6 py-3 rounded-xl text-white shadow-2xl z-[1000] animate-slide-in ${toast.type === "error" ? "bg-red-500" : "bg-emerald-500"}`}
        >
          {toast.message}
        </div>
      )}
